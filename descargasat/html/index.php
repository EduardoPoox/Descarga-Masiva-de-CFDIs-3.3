...
//*----------------------------------------------------------------*
//* Files Path: c:\xampp\htdocs\descargasat_v10b\ejemplos\html\    *
//*                                                                *
//* Modificado: 25-Dic-19                                          *
//*----------------------------------------------------------------*
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					<span class="navbar-brand">AdminCFDI v10</span>
				</div>
					    ...
					    <div role="tabpanel" class="tab-pane active" id="recibidos">
							...
							<form method="POST" class="descarga-form">
								...
								<div class="text-right">
									...
									<button type="submit" class="btn btn-success">Crear archivo ZIP de descarga</button>

									<!-- Coloca aquí la URL donde se creará el ZIP -->
									<a href="http://localhost/descargasat/html/descargasat.zip" id="iddownzip" class="classdownzip" style="display:none;" onclick="ocultarLinkDescargaZIP();">Descargar ZIP</a>
